...
class IntCtrlSigs extends Bundle {
  ...
  def decode(inst: UInt, table: Iterable[(BitPat, List[BitPat])]) = {
    ...
    val sigs = Seq(legal, fp, rocc, branch, jal, jalr, rxs2, rxs1, sel_alu2,
                   ...
                   rfs1, rfs2, rfs3, wfd, div, wxd, csr, fence_i, fence, amo, dp, mbranch)
...
class CTXDecode(implicit val p: Parameters) extends DecodeConstants
{
  val table: Array[(BitPat, List[BitPat])] = Array(
    CUSTOM0_RS1_RS2->       List(Y,N,N,N,N,N,Y,Y,A2_RS2, A1_RS1, IMM_S, DW_X,  FN_SNE,   N,M_X,        MT_X, N,N,N,N,N,N,CSR.N,N,N,N,N,Y),
    CUSTOM1_RS1_RS2->       List(Y,N,N,N,N,N,Y,Y,A2_RS2, A1_RS1, IMM_S, DW_X,  FN_SEQ,   N,M_X,        MT_X, N,N,N,N,N,N,CSR.N,N,N,N,N,Y))
}
